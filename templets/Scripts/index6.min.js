	...
	if (window.getComputedStyle || (window.getComputedStyle = function (a) {
		...
		D.startAutoplay = function () {
			...
			if (0 !== D.slides.length) {
				D.loopedSlides = "auto" === b.slidesPerView ? b.loopedSlides || 1 : b.slidesPerView + b.loopAdditionalSlides, D.loopedSlides >
					D.slides.length && (D.loopedSlides = D.slides.length);
				var a, c = "",
					d = "",
					e = "",
					f = D.slides.length,
